void h_Ptinit2()
{
  ...
  TFile* f = new TFile("HEPAnalysis_pp_ttx_mat1_qmttx_qcut60.root");
  ...
  TFile* f = new TFile("HEPAnalysis_pp_ttx_mat1_qmttx_2_qcut60.root");
  ...
  TFile* f = new TFile("HEPAnalysis_pp_ttx_mat1_qmttx_4_qcut60.root");
  ...
  */
  ...
  legend->AddEntry(h1, "t#bar{t} Q=M(t#bar{t})");
  legend->AddEntry(h2, "t#bar{t} Q=M(t#bar{t})/2");
  //legend->AddEntry(h6, "t#bar{t} Q=M(t#bar{t})/2");
  legend->AddEntry(h7, "t#bar{t} Q=M(t#bar{t})/4");
  //  legend->AddEntry(h3, "t#bar{t} Q=M(t#bar{t})/4");
