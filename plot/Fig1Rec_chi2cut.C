...
void Fig1Rec_chi2cut()
{
  ...
  // ========================
   ...
   TString f_pdf = "Fig1Rec_chi2cut.pdf";
   TString f_eps = "Fig1Rec_chi2cut.eps";
   ...
   TH1D* h_ttx_MttRec =
      ...
      ->Clone("h_ttx_MttRec");
   TH1D* h_ttx_MttRec_5 =
      (TH1D*)file_ttx->Get("h_MttRec_5_Norm")
      ->Clone("h_ttx_MttRec_5");
   TH1D* h_ttx_MttRec_4 =
      (TH1D*)file_ttx->Get("h_MttRec_4_Norm")
      ->Clone("h_ttx_MttRec_4");
   TH1D* h_ttx_MttRec_3 =
      (TH1D*)file_ttx->Get("h_MttRec_3_Norm")
      ->Clone("h_ttx_MttRec_3");
   TH1D* h_ttx_MttRec_2 =
      (TH1D*)file_ttx->Get("h_MttRec_2_Norm")
      ->Clone("h_ttx_MttRec_2");
   ...
   TH1D* h_Wmjjbbx_MttRec_5 =
      (TH1D*)file_Wmjjbbx->Get("h_MttRec_5_Norm")
      ->Clone("h_Wmjjbbx_MttRec_5");
   TH1D* h_Wmjjbbx_MttRec_4 =
      (TH1D*)file_Wmjjbbx->Get("h_MttRec_4_Norm")
      ->Clone("h_Wmjjbbx_MttRec_4");
   TH1D* h_Wmjjbbx_MttRec_3 =
      (TH1D*)file_Wmjjbbx->Get("h_MttRec_3_Norm")
      ->Clone("h_Wmjjbbx_MttRec_3");
   TH1D* h_Wmjjbbx_MttRec_2 =
      (TH1D*)file_Wmjjbbx->Get("h_MttRec_2_Norm")
      ->Clone("h_Wmjjbbx_MttRec_2");
   ...
   TH1D* h_Wmjjjj_MttRec_5 =
      (TH1D*)file_Wmjjjj->Get("h_MttRec_5_Norm")
      ->Clone("h_Wmjjjj_MttRec_5");
   TH1D* h_Wmjjjj_MttRec_4 =
      (TH1D*)file_Wmjjjj->Get("h_MttRec_4_Norm")
      ->Clone("h_Wmjjjj_MttRec_4");
   TH1D* h_Wmjjjj_MttRec_3 =
      (TH1D*)file_Wmjjjj->Get("h_MttRec_3_Norm")
      ->Clone("h_Wmjjjj_MttRec_3");
   TH1D* h_Wmjjjj_MttRec_2 =
      (TH1D*)file_Wmjjjj->Get("h_MttRec_2_Norm")
      ->Clone("h_Wmjjjj_MttRec_2");
   ...
   */                
   ...
   h_ttx_MttRec_5->SetLineWidth(2);
   h_ttx_MttRec_5->SetLineStyle(2);
   h_ttx_MttRec_5->SetLineColor(kRed+1);

   h_ttx_MttRec_4->SetLineWidth(2);
   h_ttx_MttRec_4->SetLineStyle(3);
   h_ttx_MttRec_4->SetLineColor(kRed+1);

   h_ttx_MttRec_3->SetLineWidth(2);
   h_ttx_MttRec_3->SetLineStyle(4);
   h_ttx_MttRec_3->SetLineColor(kRed+1);

   h_ttx_MttRec_2->SetLineWidth(2);
   h_ttx_MttRec_2->SetLineStyle(5);
   h_ttx_MttRec_2->SetLineColor(kRed+1);

   h_Wmjjbbx_MttRec->SetLineWidth(2);
   h_Wmjjbbx_MttRec->SetLineStyle(1);
   h_Wmjjbbx_MttRec->SetLineColor(kBlue+1);

   h_Wmjjbbx_MttRec_5->SetLineWidth(2);
   h_Wmjjbbx_MttRec_5->SetLineStyle(2);
   h_Wmjjbbx_MttRec_5->SetLineColor(kBlue+1);

   h_Wmjjbbx_MttRec_4->SetLineWidth(2);
   h_Wmjjbbx_MttRec_4->SetLineStyle(3);
   h_Wmjjbbx_MttRec_4->SetLineColor(kBlue+1);

   h_Wmjjbbx_MttRec_3->SetLineWidth(2);
   h_Wmjjbbx_MttRec_3->SetLineStyle(4);
   h_Wmjjbbx_MttRec_3->SetLineColor(kBlue+1);

   h_Wmjjbbx_MttRec_2->SetLineWidth(2);
   h_Wmjjbbx_MttRec_2->SetLineStyle(5);
   h_Wmjjbbx_MttRec_2->SetLineColor(kBlue+1);

   h_Wmjjjj_MttRec->SetMaximum(ymax);
   h_Wmjjjj_MttRec->SetMinimum(ymin);
   h_Wmjjjj_MttRec->SetLineWidth(2);
   h_Wmjjjj_MttRec->SetLineStyle(1);
   h_Wmjjjj_MttRec->SetLineColor(kGreen+1);

   h_Wmjjjj_MttRec_5->SetLineWidth(2);
   h_Wmjjjj_MttRec_5->SetLineStyle(2);
   h_Wmjjjj_MttRec_5->SetLineColor(kGreen+1);

   h_Wmjjjj_MttRec_4->SetLineWidth(2);
   h_Wmjjjj_MttRec_4->SetLineStyle(3);
   h_Wmjjjj_MttRec_4->SetLineColor(kGreen+1);

   h_Wmjjjj_MttRec_3->SetLineWidth(2);
   h_Wmjjjj_MttRec_3->SetLineStyle(4);
   h_Wmjjjj_MttRec_3->SetLineColor(kGreen+1);

   h_Wmjjjj_MttRec_2->SetLineWidth(2);
   h_Wmjjjj_MttRec_2->SetLineStyle(5);
   h_Wmjjjj_MttRec_2->SetLineColor(kGreen+1);
   ...
   /*
   h_Wmjjjj_MttRec_5->Draw("same");
   h_Wmjjbbx_MttRec_5->Draw("same");
   h_ttx_MttRec_5->Draw("same");

   h_Wmjjjj_MttRec_4->Draw("same");
   h_Wmjjbbx_MttRec_4->Draw("same");
   h_ttx_MttRec_4->Draw("same");
   */
   h_Wmjjjj_MttRec_3->Draw("same");
   h_Wmjjbbx_MttRec_3->Draw("same");
   h_ttx_MttRec_3->Draw("same");

   h_Wmjjjj_MttRec_2->Draw("same");
   h_Wmjjbbx_MttRec_2->Draw("same");
   h_ttx_MttRec_2->Draw("same");
