...
void PTtopRec_v2()
{
  ...
  // ========================
   ...
   TString f_pdf = "PTtopRec.pdf";
   TString f_eps = "PTtopRec.eps";
   ...
   Double_t factorL = (h_ttx_PTtopRec_MttRecL->GetSumOfWeights()*h_ttx_PTtopRec_MttRecL->GetBinWidth(1));
   Double_t factorH = (h_ttx_PTtopRec_MttRecH->GetSumOfWeights()*h_ttx_PTtopRec_MttRecH->GetBinWidth(1));
   factorL = 1.;
   factorH = 1.;

   TH1D* h_ttx_PTtopRec_MttRecL_Normalized =
      new TH1D((1./factorL)*(*h_ttx_PTtopRec_MttRecL));

   TH1D* h_ttx_PTtopRec_MttRecH_Normalized =
      new TH1D((1./factorH)*(*h_ttx_PTtopRec_MttRecH));
   ...
   TH1D* h_w4j_PTtopRec_MttRecL_Normalized =
      new TH1D((1./factorL)*(*h_w4j_PTtopRec_MttRecL));
   TH1D* h_w4j_PTtopRec_MttRecH_Normalized =
      new TH1D((1./factorH)*(*h_w4j_PTtopRec_MttRecH));
   ...
   */
   ...
   //   ymax = 0.014;
   ymax = 10.5;
   h_ttx_PTtopRec_MttRecL_Normalized->SetLineWidth(2);
   ...
   h_w4j_PTtopRec_MttRecL_Normalized->SetLineStyle(2);
   h_w4j_PTtopRec_MttRecL_Normalized->SetLineColor(kBlue+1);

   h_w4j_PTtopRec_MttRecL_Normalized->GetXaxis()
     ->SetTitleSize(0.06);
   h_w4j_PTtopRec_MttRecL_Normalized->GetXaxis()
      ->SetTitle("p_{T}( t or #bar{t} ) [GeV]");
   h_w4j_PTtopRec_MttRecL_Normalized->GetXaxis()
     ->CenterTitle();
   h_w4j_PTtopRec_MttRecL_Normalized->GetXaxis()
     ->SetTitleOffset(1.2);
   h_w4j_PTtopRec_MttRecL_Normalized->SetNdivisions(520, "Y");
   h_w4j_PTtopRec_MttRecL_Normalized->SetTickLength(0.04,"X");
   h_w4j_PTtopRec_MttRecL_Normalized->SetTickLength(0.02,"Y");
   h_w4j_PTtopRec_MttRecL_Normalized->SetLabelSize(0.05,"XY");
   ...
   //ymax = 0.009;
   h_ttx_PTtopRec_MttRecH_Normalized->SetLineWidth(2);
   h_ttx_PTtopRec_MttRecH_Normalized->SetLineStyle(1);
   h_ttx_PTtopRec_MttRecH_Normalized->SetLineColor(kRed+1);

   h_w4j_PTtopRec_MttRecH_Normalized->SetMaximum(ymax);
   h_w4j_PTtopRec_MttRecH_Normalized->SetMinimum(0.001);
   ...
   h_w4j_PTtopRec_MttRecH_Normalized->GetYaxis()
     ->SetTitleSize(0.06);
   h_w4j_PTtopRec_MttRecH_Normalized->GetYaxis()
     ->SetTitleOffset(0.6);
   h_w4j_PTtopRec_MttRecH_Normalized->GetXaxis()
      ->SetTitle("p_{T}(t or #bar{t}) [GeV]");
   h_w4j_PTtopRec_MttRecH_Normalized->GetYaxis()
      ->SetTitle("d#sigma / d p_{T}( t or #bar{t} ) [fb/GeV]");
   h_w4j_PTtopRec_MttRecH_Normalized->SetNdivisions(520, "Y");
   h_w4j_PTtopRec_MttRecH_Normalized->SetTickLength(0.04,"X");
   h_w4j_PTtopRec_MttRecH_Normalized->SetTickLength(0.02,"Y");
   h_w4j_PTtopRec_MttRecH_Normalized->SetLabelSize(0.055,"XY");

   h_w4j_PTtopRec_MttRecH_Normalized->Draw();
