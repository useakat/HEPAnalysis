...
void Fig2Rec_v2()
{
  ...
  // ========================
   ...
   Double_t legend_l_1 = 0.18;
   Double_t legend_r_1 =0.43;
   Double_t legend_t_1 = 0.93;
   Double_t legend_b_1 = 0.7;
   ...
   Double_t legend_l_2 = 0.18;
   Double_t legend_r_2 =0.43;
   Double_t legend_b_2 = 0.62;
   Double_t legend_t_2 = 0.86;
   ...
   */
   ...
   legend = new TLegend(0.18,0.77,0.43,0.98);
